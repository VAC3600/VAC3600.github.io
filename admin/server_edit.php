...
echo "						</select></div>
					...
					<div class='row'>
						<div class='right'>
							...
							<button type='submit' class='btn btn-danger'><span>Сохранить</span></button> <button type='button' class='btn btn-info' onClick=\"window.location.href='server/$id/'\"><span>Отмена</span></button>
						</div>
					</div>
