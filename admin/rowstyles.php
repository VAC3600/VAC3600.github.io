...
echo '
				<form action="" method="POST">
					...
					<div class="row">
						<div class="right">
							<button type="submit" name="submit" class="btn btn-warning"><span>Добавить стиль</span></button> 
							<button type="button" name="submit" class="btn btn-primary" onClick="window.location.href=\'index.php\';"><span>Отмена</span></button>
						</div>
					</div>
				</form>
			</div>
