...
class ServerEdit {
	...
	public function SendMail() {
		...
		$this->subject = "Редактирование сервера :: WWW.CS-GET.RU";
		$this->message = "
Zdravstvyite. Vi otpravili zapros na redaktirovanie servera v monitoringe MON-SERVERS.RU.
Dlya perexoda k stranice redaktirovania vospol'zyites' ssilkoy : {$settings['site_url']}edit/key/{$this->secret_key}/
Ssilka bydet dostypna v te4enii 30 minyt c nachala podachi zayavki.
			Esli vi ne podavali zayavki, to prosto proignoriryite dannoe pis'mo.
";
