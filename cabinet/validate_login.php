...
<html><head></head><body>﻿﻿
<meta http-equiv="Refresh" content="4; URL=http://adrenaline-cs.esy.es/cabinet/profile.php">
...
$result = mysql_query("SELECT * FROM users WHERE login='$login'",$db); //извлекаем из базы все данные о пользователе с введенным логином
	...
	$_SESSION['names']=$myrow['names'];
	$_SESSION['email']=$myrow['email'];	
    echo "  
  <center><br><br><br><br><br><br><br><br><br><br>
  Вы успешно вошли с свойм логином на сайт!<br>
  Вы будите перенаправлены на личный кабинет через 4 секунды...</a></center>";
    }
 else {
    //если пароли не сошлись

    exit ("<br><br><br><br><br><br><br>Извините, введённый вами login или пароль неверный.");
    }
    }
    ?>